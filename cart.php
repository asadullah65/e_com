...
<div class="header-1">
    ...
    <a href="index.php" class="logo" > <img src="https://global-uploads.webflow.com/5e157548d6f7910beea4e2d6/612d7e1b1e7961cb4cf8cf4b_logo_18771c89-12be-4fa8-a9b1-688c4483410e.png" alt="Logo image" class="hidden-xs">  </a>
...
<a id="pr" href="#"> Shopping Cart Total Price: RS: <?php totalPrice(); ?>, Total Items <?php item(); ?></a>
</div>
  ...
  <div class="d-3">
    <div class="product same-height">
      ...
      <div class="tet">
        ...
        <p class="price"><i class="fa fa-RS:"></i>199</p>
      </div>
    </div>
  </div>
  <div class="d-3">
    <div class="product same-height">
      ...
      <div class="tet">
        ...
        <p class="price"><i class="fa fa-RS:"></i>99</p>
      </div>
    </div>
  </div>
  <div class="d-3">
    <div class="product same-height">
      ...
      <div class="tet">
        ...
        <p class="price"><i class="fa fa-RS:"></i>16</p>
      </div>
    </div>
  </div>
  <div class="d-3">
    <div class="product same-height">
      ...
      <div class="tet">
        ...
        <p class="price"><i class="fa fa-RS:"></i>340</p>
      </div>
    </div>
  </div>
  <div class="d-3">
    <div class="product same-height">
      ...
      <div class="tet">
        <h3><a href="details.php">Origenal Scissor</a></h3>
        <p class="price"><i class="fa fa-RS:"></i>70</p>
      </div>
    </div>
  </div>
  <div class="d-3">
    <div class="product same-height">
      ...
      <div class="tet">
        ...
        <p class="price"><i class="fa fa-RS:"></i>76</p>
      </div>
    </div>
  </div>
   <div class="d-3">
    <div class="product same-height">
      ...
      <div class="tet">
        ...
        <p class="price"><i class="fa fa-RS:"></i>85</p>
      </div>
    </div>
  </div>
   <div class="d-3">
    <div class="product same-height">
      ...
      <div class="tet">
        ...
        <p class="price"><i class="fa fa-RS:"></i>20</p>
      </div>
    </div>
  </div>
</div>
